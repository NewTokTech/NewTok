  ...
  return (
    <>
      ...
      <div className="mx-auto mt-36 mb-10">
        ...
        <h1 className="text-secondary lg:text-[30px] mt-5 text-center font-inter font-semibold">
          GET IN <span className="text-primary">TOUCH</span>
        </h1>
        <div className="flex justify-center">
          <p className="px-auto text-secondary lg:text-[16px] mt-5 mb-5 text-center font-inter ">
            Don’t worry about it getting too long. We know your awesome ideas
            take time to explain; the more we learn about it the better <br />{" "}
            we can help you out. We would love to hear all about your project.
            Connect with us through the contact form for a free initial <br />{" "}
            project consultation. Contact us and see what .
          </p>
        </div>
      </div>

      <div className="bg-white rounded-lg mx-32 relative sm:items-center sm:pt-0 ">
        <div className="flex flex-col md:flex-row items-center md:items-start ">
          <div className="w-full md:w-2/5 h-full my-auto">
            <div className="sm:rounded-lg bg-secondary text-white h-full relative py-16">
              ...
              <div className="py-16 flex flex-col space-y-10 px-10">
