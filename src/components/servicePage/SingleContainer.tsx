    ...
    <>
      ...
      <div className="relative  xl:mx-52 ">
        <Image
          ...
          width={687}
          height={498}
          className={`scale-75 sxl:hidden block  xl:scale-90 overflow-visible -mb-10`}
        />
          ...
          <div className="m-auto px-6 md:px-12 xl:px-6 xl:my-16">
            <div className={`xl:space-y-6 md:space-y-0 xl:flex  ${position === 'left' ? 'xl:justify-end' : 'xl:justify-start'} md:gap-6 xl:items-center xl:gap-12`}>
              <Image
                ...
                width={600}
                height={498}
                className={`absolute  bottom-0 sxl:block hidden scale-75 xl:scale-100 overflow-visible ${position === 'left' ? '-left-4 ' : 'right-0'}`}
              />
