...
const whyUsArray = [
  ...
  { head: " Industry Expertise", p: " Our experience spans a wide range of industries, giving us a deep understanding of industry-specific challenges and opportunities." },
];
